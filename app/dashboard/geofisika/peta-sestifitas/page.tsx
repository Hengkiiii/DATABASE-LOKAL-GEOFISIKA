...
export default function PetaRawanGempa() {
    const [microthermorData, setMicrothermorData] = useState<
        MicrothermorData[]
    >([]);
    ...
    useEffect(() => {
        ...
        if (storedData) {
            try {
                ...
                console.error(
                    "❌ Gagal parsing data dari sessionStorage:",
                    err
                );
            }
        } else {
                                ...
                                >
                                    <Popup>
                                        <div className="space-y-1">
                                            ...
                                            <p>
                                                <strong>Lokasi:</strong> {lat},{" "}
                                                {lng}
                                            </p>
                                            <p>
                                                <strong>Fo:</strong> {data.Fo}{" "}
                                                Hz
                                            </p>
                                            <p>
                                                <strong>Ao:</strong> {data.Ao}{" "}
                                                mm/s
                                            </p>
                                            <p>
                                                <strong>Tdom:</strong>{" "}
