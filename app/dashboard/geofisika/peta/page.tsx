...
export default function Page() {
  ...
  // Fungsi pemetaan data dari API/session
  const mapGempaData = (raw: any[]) => {
    return raw.map((item: any) => {
      ...
      return {
        ...
        latitude: parseFloat(item.latitude || item.lintang || "0"),
        longitude: parseFloat(item.longitude || item.bujur || "0"),
