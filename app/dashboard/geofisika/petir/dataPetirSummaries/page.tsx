...
import TabelDataPetirSummaries from "@/components/common/tabel/tabelPetir/TabelDataPetirSummaries";
    ...
    const handleSave = async () => {
        try {
            ...
            if (inputType === "manual") {
                ...
                if (result?.success) {
                    toast.success(
                        "Data petir berhasil diupload dari file Excel"
                    );
                    setIsOpenModal(false);
                    resetForm();
                } else {
