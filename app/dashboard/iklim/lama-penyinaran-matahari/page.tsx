    ...
    try {
      ...
      if (inputType === "manual") {
        ...
        if (isNaN(Number(lamaPenyinaran))) {
          toast.warning("Lama penyinaran harus berupa angka (dalam string)");
          return;
        }
        const result = await tambahDataSunshineDuration(
          user_id,
          lamaPenyinaran,
          tanggal
        );
      ...
      toast.error("Gagal menambahkan data lama penyinaran matahari");
    }
  };
            ...
            {inputType === "otomatis" && (
              <div>
                ...
                <p className="text-xs text-black mt-2">
                  ...
                  <strong className="text-red-800">lama penyinaran</strong>{" "}
                  setiap hari.
                </p>
              </div>
            )}
