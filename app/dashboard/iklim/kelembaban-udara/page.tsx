...
export default function KelembabanUdaraPage() {
  ...
  const handleExcelSubmit = async () => {
    try {
      ...
      console.error("Gagal menambahkan data kelembaban dari file:", error);
          ...
          >
            <div>
              ...
              <p className="text-xs text-black mt-2">
                ...
                <strong className="text-red-800">Jam 13:00</strong>, dan{" "}
                <strong className="text-red-800">Jam 18:00</strong>.
              </p>
            </div>
          </div>
