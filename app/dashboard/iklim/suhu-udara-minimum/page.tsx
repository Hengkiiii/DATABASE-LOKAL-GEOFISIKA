...
export default function SuhuUdaraMaksimumPage() {
    ...
    const handleManualSubmit = async () => {
        try {
            ...
            toast.success("Data suhu udara minimum berhasil ditambahkan");
            ...
            toast.error(
                error instanceof Error
                    ? error.message
                    : "Gagal menambahkan data suhu udara minimum"
            );
        }
    };
    ...
    const handleSubmitOtomatis = async () => {
        try {
            ...
            toast.success(
                "Data suhu udara minimum dari file berhasil ditambahkan"
            );
            setIsOpenModal(false);
            resetForm();
            handleReload();
