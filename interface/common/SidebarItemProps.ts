...
export interface SidebarItemProps {
  ...
  onClick?: () => void; // Fungsi yang dipanggil saat item diklik
  ...
  children?: ReactElement<SidebarItemProps>[] | ReactElement<SidebarItemProps>; // Menandakan apakah item ini memiliki anak
}
