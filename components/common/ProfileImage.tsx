...
const ProfileImage: FC<ProfileImageProps> = ({
    ...
    return (
        <motion.div className="relative group" ref={profileRef}>
            {/* Avatar pengguna dengan border gradasi */}
            <div className="p-[2px] bg-gradient-to-tr from-blue-500 to-green-600 rounded-full">
                <div
                    className="w-10 h-10 rounded-full border-[2px] border-white dark:border-gray-900 hover:opacity-90 transition duration-300 cursor-pointer overflow-hidden"
