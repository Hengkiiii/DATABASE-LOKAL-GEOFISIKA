  ...
  const handleSaveEdit = async () => {
    ...
    console.log("handleSaveEdit: mulai update data", {
      ...
      dataUpdate: {
        ...
        village: selectedData.village || "Kabawetan",
      },
    });
  ...
  return (
    <Card style="relative bg-white p-6 md:p-8 space-y-6 shadow-xl rounded-2xl">
              ...
              <div className="flex justify-between gap-2 pt-2">
                ...
                <Button
                  ...
                  onClick={() => {
                    setStartDate("");
                    setEndDate("");
                    sessionStorage.removeItem("dataPosHujanKabawetan");
                    fetchAllData();
                    setShowFilter(false);
                  }}
      ...
      <div className="flex justify-center items-center gap-6 pt-6">
        ...
        >
          Next {<MdArrowForwardIos size={18} className="mt-1" />}
        </Button>
      </div>
