...
export default function ModalHapusLamaPenyinaran({
  show,
  data,
  onClose,
  onDelete,
  isDarkMode,
}: ModalHapusLamaPenyinaranProps) {
  return (
    <AnimatePresence>
      {show && data && (
        <motion.div
        ...
        >
          ...
          >
            ...
            <p className="text-sm">
              ...
              <strong>{data.date}</strong> dengan lama penyinaran{" "}
              <strong>{data.sunshine_duration}Jam</strong>?
            </p>
