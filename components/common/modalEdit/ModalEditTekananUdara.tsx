...
interface ModalEditTekananUdaraProps {
  show: boolean;
  isDarkMode: boolean;
  data: TabelTekananUdara | null;
  onClose: () => void;
  onSave: (data: TabelTekananUdara) => void;
  setData: React.Dispatch<React.SetStateAction<TabelTekananUdara | null>>;
}

export default function ModalEditTekananUdara({
  show,
  data,
  onClose,
  onSave,
    ...
    <AnimatePresence>
      {show && data && (
        ...
        >
          ...
          >
            <h3 className="text-lg font-semibold">Edit Data Tekanan Udara</h3>
            ...
            <div className="space-y-2">
              ...
              <div>
                ...
                <input
                  type="number"
                  value={data.tekananPagi}
                  onChange={(e) =>
                    setData({
                      ...data,
                      tekananPagi: parseFloat(e.target.value),
                    })
                  }
                  className={`w-full px-3 py-2 rounded border ${
                    isDarkMode
              ...
              <div>
                ...
                <input
                  type="number"
                  value={data.tekananSiang}
                  onChange={(e) =>
                    setData({
                      ...data,
                      tekananSiang: parseFloat(e.target.value),
                    })
                  }
                  className={`w-full px-3 py-2 rounded border ${
                    isDarkMode
              ...
              <div>
                ...
                <input
                  type="number"
                  value={data.tekananSore}
                  onChange={(e) =>
                    setData({
                      ...data,
                      tekananSore: parseFloat(e.target.value),
                    })
                  }
                  className={`w-full px-3 py-2 rounded border ${
                    isDarkMode
