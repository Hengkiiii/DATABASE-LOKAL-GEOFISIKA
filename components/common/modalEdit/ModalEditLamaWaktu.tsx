...
interface ModalEditTandaWaktuProps {
  show: boolean;
  data: TandaWaktu | null;
  onClose: () => void;
  onSave: (data: TandaWaktu) => void;
  isDarkMode: boolean;
  setData: React.Dispatch<React.SetStateAction<TandaWaktu | null>>;
}

export default function ModalEditTandaWaktu({
  show,
  data,
  onClose,
  onSave,
    ...
    <AnimatePresence>
      {show && data && (
        ...
        >
          ...
          >
            <h3 className="text-lg font-semibold">Edit Data Tanda Waktu</h3>
